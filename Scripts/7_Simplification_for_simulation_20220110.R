  ...
  df_household_kable = household%>%
    ...
    mutate(
      ...
      variable = case_when(
        ...
        variable == "cycle_family_05" ~ "Famille dont l'enfant le plus ag� a moins de 5 ans",
        variable == "cycle_family_611" ~ "Famille dont l'enfant le plus ag� a entre 6 et 11 ans",
        variable == "cycle_family_1217" ~ "Famille dont l'enfant le plus ag� a entre 12 et 17 ans",
        variable == "cycle_family_1824" ~ "Famille dont l'enfant le plus ag� a entre 18 et 24 ans",
        variable == "cycle_single_35" ~ "C�libataire en dessous de 35 ans",
        variable == "cycle_single_3565" ~ "C�libataire entre 35 et 65 ans",
        variable == "cycle_single_65" ~ "C�libataire au dessus de 65 ans",
